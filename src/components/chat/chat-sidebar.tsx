...
export function ChatSidebar({ className, ...props }: ChatSidebarProps) {
  return (
    <div className={cn("flex flex-col h-full bg-white border-r w-[280px]", className)} {...props}>
        {/* Header */}
        <div className="p-4 pb-2">
            ...
            <Button className="w-full justify-start gap-2 bg-pink-600 hover:bg-pink-700 text-white shadow-sm transition-all hover:scale-[1.02] active:scale-[0.98]" size="lg">
        ...
        <div className="flex-1 overflow-auto px-3">
            <div className="mb-2 px-4 text-xs font-semibold text-muted-foreground uppercase tracking-wider">
             ...
             <nav className="space-y-1 mb-6">
                <Button variant="ghost" className="w-full justify-start text-left font-normal h-auto py-2 text-muted-foreground hover:text-foreground hover:bg-gray-100/50">
        ...
        <div className="p-4 border-t mt-auto">
            <div className="flex items-center gap-3 w-full p-2 hover:bg-gray-100 rounded-md cursor-pointer transition-colors group">
                 <Avatar className="w-9 h-9 border ring-2 ring-transparent group-hover:ring-pink-100 transition-all">
                    <AvatarImage src="/placeholder-user.jpg" alt="@user" />
                    <AvatarFallback className="bg-gradient-to-br from-pink-500 to-purple-500 text-white">JD</AvatarFallback>
                </Avatar>
