...
export function ChatLayout({ sidebar, toc, children, className }: ChatLayoutProps) {
  ...
  return (
    <div className={cn("flex h-screen bg-white overflow-hidden w-full", className)}>
        {/* Left Sidebar */}
        <div 
            className={cn(
                "flex-shrink-0 transition-all duration-300 ease-in-out border-r bg-gray-50/50 relative z-20",
        ...
        {toc && (
            <div 
                className={cn(
                    "flex-shrink-0 transition-all duration-300 ease-in-out border-l bg-white hidden lg:block",
