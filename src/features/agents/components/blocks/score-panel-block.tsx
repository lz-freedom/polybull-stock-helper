...
const recommendationColors = {
    strong_buy: 'bg-success/10',
    buy: 'bg-success/10',
    hold: 'bg-warning/10',
    sell: 'bg-destructive/10',
    strong_sell: 'bg-destructive/10',
};
            ...
            <CardContent className="space-y-6">
                <div className="flex flex-col md:flex-row items-center justify-between gap-6 p-6 bg-muted/30 rounded-lg">
                    ...
                    <div className="flex flex-col items-center md:items-end">
                        <Badge 
                            className={cn(
                                'text-lg px-4 py-1 mb-2 text-primary-foreground', 
                                recommendationColors[final_verdict.recommendation] || 'bg-muted',
                            )}
                        >
