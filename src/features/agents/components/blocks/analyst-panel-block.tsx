                ...
                <div className="p-4 text-sm space-y-3">
                  <div className="flex items-center justify-between text-xs text-muted-foreground">
                     <span className={cn(
                       ...
                       analyst.analysis.stance === 'bullish' ? "bg-green-100 text-green-700 dark:bg-green-900/30 dark:text-green-300" :
                       analyst.analysis.stance === 'bearish' ? "bg-red-100 text-red-700 dark:bg-red-900/30 dark:text-red-300" :
