      ...
      <div className="relative mx-auto max-w-4xl">
        ...
        <div className="space-y-4">
          {items.map((faq, index) => (
            <details 
              key={index} 
              className="group rounded-3xl border border-border/50 bg-card/50 p-6 transition-all hover:bg-card hover:shadow-lg open:bg-card open:shadow-xl dark:bg-white/5 dark:hover:bg-white/10"
            >
